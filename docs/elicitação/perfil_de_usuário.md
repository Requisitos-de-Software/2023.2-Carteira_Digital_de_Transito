...
Para a definição do perfil de usuário, foram empregas duas metodologias distintas: a aplicação de questionários, devido à sua eficácia na obtenção de informações diretas junto aos usuários, e a análise de documentação, um método valioso por sua capacidade de oferecer insights provenientes de fontes escritas e registros existentes.
...
## 📑 Histórico de versões:
 ...
 :-----: | :--------: | :-----------------------------------------------------: | :-----------------------------------------------------------------------------------------------: | :--------------------------------------------: 
  ...
  `1.1`  | 11/10/2023 |            adicionando perfil de usuário atraves de análise de documentação           | [Mayara Alves](https://github.com/Mayara-tech) | [Breno Queiroz](https://github.com/brenob6)

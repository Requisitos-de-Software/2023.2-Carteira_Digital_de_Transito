...
**Figura 1** - Percentual das respostas obtidas na verificação 
 ...
 ![Gráfico - respostas da verificação](../assets/verificacao/percentual_Avaliação.PNG)
...
| ------ | ---------- | ----------------------------------------------- | -----------------------------------------------| ---------------------------------------------|
| `1.0`  | 26/11/2023 | Adicionando verificação do artefato Rich Picture   | [Mayara Alves](https://github.com/Mayara-tech) |  |

...
| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** | **Autor** |
|---------|------|--------|----------|------------|------------|
| Condutor (Usuário) - (L02) | Objeto | - Pessoa que conduz um automóvel </br> - Responsável pelo veículo </br> - Responsável pelas [infrações](#L03) </br> - Condutor pode ser alguém que queira visualizar sua CNH digital </br> - O condutor pode ser alguém que queira visualizar a CRLV digital | - O condutor pode baixar sua CNH digital </br> - O condutor pode visualizar seu histórico de emissões da CNH  </br> - O condutor pode adicionar os seus veículos </br> - O condutor pode consultar as suas [infrações](#L03) | Motorista, volante, guia, piloto | [Vinícius Mendes](https://github.com/yabamiah) | 
| Infração - (L03) | Objeto | - Violação de alguma lei de trânsito </br> - A infração é visualizada pelo [condutor](#L02) | - O [condutor](#L02) pode visualizar as infrações cometidas filtrando infrator ou veículo </br> - O [condutor](#L02) pode visualizar a situação da infração </br> - O [condutor](#L02) pode visualizar o motivo da infração </br> - O [condutor](#L02) pode consultar o valor da infração a ser paga| Desobediência, Violação |[Luis Miranda](https://github.com/LuisMiranda10) |
| Sistema de Notificação Eletrônica - (L04) | Objeto | - Sistema responsável por notificar [infrações](#L03) de trânsito aos proprietários de veículos | - Sistema que dá o direito a descontos no pagamento de multas de trânsitos | Sistema de Intimação Eletrônica |[Vinícius Mendes](https://github.com/yabamiah) | 
| Restrições e Indicadores do veículo do condutor - (L05)  |Objeto | - Responsável por mostrar ao [condutor](#L02) se existe multa, [infrações](#L03), restrição judicial, ocorrência de roubo, novo padrão na placa, comunicações de venda ativa e restrições do seu próprio veículo | - O [condutor](#L02) do veiculo pode consultar os indicadores e restrições de seu veiculo  | Limitações, Indicativos | [Luis Miranda](https://github.com/LuisMiranda10) |
| Tutorial - (L06) | Objeto | - Documentação para orientar o [condutor](#L02) ao utilizar o app | - Aumenta a eficiência de aprendizado do [condutor](#L02)  | Auxílio, Orientação, Documentação | [Luis Miranda](https://github.com/LuisMiranda10) |
...
| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** | **Autor** |
|---------|------|--------|----------|------------|------------|
| Cadastrar CNH - (L07) | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) precisa visualizar sua CNH pela primeira vez </br> - [condutor](#L02) valida o cadastro com uma foto de sua CNH  | - O [condutor](#L02) consegue visualizar a sua CNH  | Registrar CNH, Inscrever CNH, Fichar CNH | [Vinícius Mendes](https://github.com/yabamiah) | 
| Consultar infrações - (L08) | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) quer visualizar alguma [infrações](#L03) </br> - [condutor](#L02) pode escolher consultar [infrações](#L03) por condutor ou por veículo </br> - O sistema divide as [infrações](#L03) em categorias de vencidas, a vencer e pagas | - O [condutor](#L02) consegue verificar [infrações](#L03) vencidas e as não pagas </br> - O [condutor](#L02) pode visualizar uma [infrações](#L03) </br> - O sistema pode gerar o boleto da [infrações](#L03) </br> - O sistema pode gerar PDF da [infrações](#L03) |  Examinar infrações, Estudar infrações, Ler infrações| [Vinícius Mendes](https://github.com/yabamiah) | 
| Consultar Exames Toxicológicos - (L09) | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) quer visualizar algum exame toxicológico feito pelo mesmo </br> - O sistema divide as informações sobre os exames toxicológicos em categorias de Data de Coleta, Prazo para nova realização de exame e Laboratórios credenciados| - O [condutor](#L02) consegue verificar [infrações](#L03) sobre os exames | Inspecionar exames toxicológicos | [Luis Miranda](https://github.com/LuisMiranda10) |
| Visualizar recall - (L10) | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer consultar se foi feita uma notificação de regularização do seu veículo | - O [condutor](#L02) consegue visualizar se o seu veículo recebeu algum recall </br>  | Verificar recall, Constatar recall, Captar recall | [Vinícius Mendes](https://github.com/yabamiah) | 
| Visualizar Licenciamento - (L11) | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer consultar o CRLV do seu veículo | - O [condutor](#L02) consegue visualizar as informações do licenciamento do seu carro </br> - O [condutor](#L02) consegue compartilhar seu licenciamento com outras pessoas </br> - O [condutor](#L02) consegue exportar seu licenciamento para algum tipo de arquivo selecionado </br> | Analisar informações sobre o veículo | [Luis Miranda](https://github.com/LuisMiranda10) |
| Transferência - (L12)| Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer transferir a propriedade de um veículo para outra pessoa | - O veículo se torna propriedade de outra pessoa  | Realiza troca de proprietário | [Luis Miranda](https://github.com/LuisMiranda10) |

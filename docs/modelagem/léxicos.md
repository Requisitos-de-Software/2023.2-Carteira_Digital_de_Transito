...
### <a name="L01"></a>L01 - Cadastro positivo está inativo

<p align="center"><b>Tabela 03</b> - Léxico 01 - Cadatro positivo está inativo (L01)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Cadastro positivo está inativo | Estado | - O [condutor](#L02) autorizou participar voluntariamente no cadastro positivo </br> - Ocorre quando o condutor quebrou alguma regra do código de trânsito brasileiro  | - O [condutor](#L02) fica sem receber benefícios do Cadastro Positivo </br> - O cadastro só ficará ativo quando o condutor resolver a causa da situação | Cadastro positivo está desligado, Cadastro positivo está desativado|

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>

### <a name="L02"></a>L02 - Condutor

<p align="center"><b>Tabela 04</b> - Léxico 02 - Condutor (L02)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Condutor | Objeto | - Pessoa que conduz um automóvel </br> - Responsável pelo veículo </br> - Responsável pelas [infrações](#L03) </br> - Condutor pode ser alguém que queira visualizar sua CNH digital </br> - O condutor pode ser alguém que queira visualizar a CRLV digital | - O condutor pode baixar sua CNH digital </br> - O condutor pode visualizar seu histórico de emissões da CNH  </br> - O condutor pode adicionar os seus veículos </br> - O condutor pode consultar as suas [infrações](#L03) | Motorista, volante, guia, piloto |

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>

### <a name="L03"></a>L03 - Infração

<p align="center"><b>Tabela 05</b> - Léxico 03 - Infração (L03)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Infração | Objeto | - Violação de alguma lei de trânsito </br> - A infração é visualizada pelo [condutor](#L02) | - O [condutor](#L02) pode visualizar as infrações cometidas filtrando infrator ou veículo </br> - O [condutor](#L02) pode visualizar a situação da infração </br> - O [condutor](#L02) pode visualizar o motivo da infração </br> - O [condutor](#L02) pode consultar o valor da infração a ser paga| Desobediência, Violação |

<p align="center"><b>Fonte</b>: <a href=https://github.com/LuisMiranda10>Luis Miranda</a> </p>

### <a name="L04"></a>L04 - Sistema de Notificação Eletrônica

<p align="center"><b>Tabela 06</b> - Léxico 04 -Sistema de Notificação Eletrônica (L04)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Sistema de Notificação Eletrônica | Objeto | - Sistema responsável por notificar [infrações](#L03) de trânsito aos proprietários de veículos | - Sistema que dá o direito a descontos no pagamento de multas de trânsitos | Sistema de Intimação Eletrônica |

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>

### <a name="L05"></a>L05 - Restrições e Indicadores

<p align="center"><b>Tabela 07</b> - Léxico 05 - Restrições e Indicadores do veículo do condutor(L05)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Restrições e Indicadores |Objeto | - Responsável por mostrar ao [condutor](#L02) se existe multa, [infrações](#L03), restrição judicial, ocorrência de roubo, novo padrão na placa, comunicações de venda ativa e restrições do seu próprio veículo | - O [condutor](#L02) do veiculo pode consultar os indicadores e restrições de seu veiculo  | Limitações, Indicativos |

<p align="center"><b>Fonte</b>: <a href=https://github.com/LuisMiranda10>Luis Miranda</a> </p>

### <a name="L06"></a>L06 - Tutorial

<p align="center"><b>Tabela 08</b> - Léxico 06 - Tutorial (L06)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Tutorial | Objeto | - Documentação para orientar o [condutor](#L02) ao utilizar o app | - Aumenta a eficiência de aprendizado do [condutor](#L02)  | Auxílio, Orientação, Documentação |

<p align="center"><b>Fonte</b>: <a href=https://github.com/LuisMiranda10>Luis Miranda</a> </p>

### <a name="L07"></a>L07 - Cadastrar CNH

<p align="center"><b>Tabela 09</b> - Léxico 07 - Cadastrar CNH (L07)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Cadastrar CNH | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) precisa visualizar sua CNH pela primeira vez </br> - [condutor](#L02) valida o cadastro com uma foto de sua CNH  | - O [condutor](#L02) consegue visualizar a sua CNH  | Registrar CNH, Inscrever CNH, Fichar CNH |

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>

### <a name="L08"></a>L08 - Consultar infrações

<p align="center"><b>Tabela 10</b> - Léxico 08- - Consultar infrações (L08)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Consultar infrações | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) quer visualizar alguma [infrações](#L03) </br> - [condutor](#L02) pode escolher consultar [infrações](#L03) por condutor ou por veículo </br> - O sistema divide as [infrações](#L03) em categorias de vencidas, a vencer e pagas | - O [condutor](#L02) consegue verificar [infrações](#L03) vencidas e as não pagas </br> - O [condutor](#L02) pode visualizar uma [infrações](#L03) </br> - O sistema pode gerar o boleto da [infrações](#L03) </br> - O sistema pode gerar PDF da [infrações](#L03) |  Examinar infrações, Estudar infrações, Ler infrações|

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>
  
### <a name="L09"></a>L09 - Consultar exames Toxicológicos

<p align="center"><b>Tabela 11</b> - Léxico 09- Consultar Exames Toxicológicos (L09)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Consultar Exames Toxicológicos | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Acontece quando o [condutor](#L02) quer visualizar algum exame toxicológico feito pelo mesmo </br> - O sistema divide as informações sobre os exames toxicológicos em categorias de Data de Coleta, Prazo para nova realização de exame e Laboratórios credenciados| - O [condutor](#L02) consegue verificar [infrações](#L03) sobre os exames | Inspecionar exames toxicológicos |

<p align="center"><b>Fonte</b>: <a href=https://github.com/LuisMiranda10>Luis Miranda</a> </p>
  
### <a name="L10"></a>L10 - Visualizar recall

<p align="center"><b>Tabela 12</b> - Léxico 10 - Visualizar recall (L10)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Visualizar recall | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer consultar se foi feita uma notificação de regularização do seu veículo | - O [condutor](#L02) consegue visualizar se o seu veículo recebeu algum recall </br>  | Verificar recall, Constatar recall, Captar recall |

<p align="center"><b>Fonte</b>: <a href=https://github.com/yabamiah>Vinicius Mendes</a> </p>

### <a name="L11"></a>L11 - Visualizar CRLV

<p align="center"><b>Tabela 13</b> - Léxico 11 - Visualizar CRLV (L11)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Visualizar Licenciamento | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer consultar o CRLV do seu veículo | - O [condutor](#L02) consegue visualizar as informações do licenciamento do seu carro </br> - O [condutor](#L02) consegue compartilhar seu licenciamento com outras pessoas </br> - O [condutor](#L02) consegue exportar seu licenciamento para algum tipo de arquivo selecionado </br> | Analisar informações sobre o veículo |

<p align="center"><b>Fonte</b>: <a href=https://github.com/LuisMiranda10>Luis Miranda</a> </p>

### <a name="L12"></a>L12 - Transferência

<p align="center"><b>Tabela 14</b> - Léxico 12 - Transferência (L12)</p>

| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** |
|---------|------|--------|----------|------------|
| Transferência | Verbo | - Tarefa realizada pelo [condutor](#L02) </br> - Ocorre quando o [condutor](#L02) quer transferir a propriedade de um veículo para outra pessoa | - O veículo se torna propriedade de outra pessoa  | Realiza troca de proprietário |

...
| **Símbolo** | **Tipo** | **Noção** | **Impacto** | **Dicionário** | **Autor** |
|---------|------|--------|----------|------------|------------|
|<a id="L02"> Condutor (Usuário) - (L02)</a> | Objeto | - Pessoa que conduz um automóvel </br> - Responsável pelo veículo </br> - Responsável pelas <a href="#L03">infrações</a> </br> - Condutor pode ser alguém que queira visualizar sua CNH digital </br> - O condutor pode ser alguém que queira visualizar a CRLV digital | - O condutor pode baixar sua CNH digital </br> - O condutor pode visualizar seu histórico de emissões da CNH  </br> - O condutor pode adicionar os seus veículos </br> - O condutor pode consultar as suas <a href="#L03">infrações</a> | Motorista, volante, guia, piloto | [Vinícius Mendes](https://github.com/yabamiah) | 
